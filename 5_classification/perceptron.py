...
class PerceptronClassifier:
    ...
    def train( self, trainingData, trainingLabels, validationData, validationLabels ):
        ...
        for iteration in range(self.max_iterations):
            ...
            for i in range(len(trainingData)):
                ...
                # find the label with maximum score
                ...
                # update weight if predicted label are not ground truth label
                if predictLabel != trainingLabels[i]:
                    self.weights[trainingLabels[i]] += trainingData[i]
                    self.weights[predictLabel] -= trainingData[i]
    ...
    def findHighWeightFeatures(self, label):
        ...
        sortedWeights = weights.sortedKeys()
        featuresWeights.extend(sortedWeights[0:100])
